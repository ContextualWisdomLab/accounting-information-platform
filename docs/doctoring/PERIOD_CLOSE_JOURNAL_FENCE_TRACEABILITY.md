...
| Concern | Chosen / required control | Rejected alternative or repaired finding | Executable evidence |
|---|---|---|---|
...
| Compatible database open-path coordination | Open journals share the control-row lock; only journals landing on the same stripe compete for the stripe UPDATE | Treating database lock compatibility, or removal of the application period mutex, as a performance result without exact-head concurrent measurement | `tests/test_postgres_open_period_journal_fence.py::test_open_period_posting_can_progress_while_peer_holds_share_fence` |
...
- Open-period application mutex production repair: `430f4dde6757c8bf09243a00787dabcfa97ab49c`; stronger static no-command-lock ratchet: `70c07aba7c51391b9ee965fe3948b23c9546642d`.
