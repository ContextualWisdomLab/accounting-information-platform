...
| `integration_outbox` | Transactional publication evidence and append-only audit history; reconciliation authority retains exactly one matching event after commit while publication metadata may advance |
