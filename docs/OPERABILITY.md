...
transactions to sixty seconds. Readiness sessions additionally bound every
connected statement operation to five seconds, preserving a stricter configured
statement timeout. State-changing proposal, adjusting, reversal,
