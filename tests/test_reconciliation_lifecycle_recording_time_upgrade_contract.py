...
_MIGRATION = _ROOT / "database/migrations/0027_reconciliation_lifecycle_recording_time_authority.sql"


class ReconciliationLifecycleRecordingTimeUpgradeContractTests(unittest.TestCase):
    """Prevent pre-0027 caller-shaped system time from becoming close authority."""

    def test_upgrade_refuses_unverifiable_legacy_transition_rows(self) -> None:
        """A pre-0027 transition cannot be silently promoted to database-clock authority."""
