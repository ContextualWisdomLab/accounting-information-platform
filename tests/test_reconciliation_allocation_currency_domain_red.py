...
currency syntax. Aggregate planning inherits currency from admitted source
evidence on both statement and journal sides, so independently assembled currency
scalars cannot become reviewable reconciliation evidence.
"""
...
class ReconciliationAllocationCurrencyDomainRedTests(unittest.TestCase):
    ...
    def _statement(*, currency_code: str = "USD") -> StatementEntryEvidence:
        """Construct matching statement-side evidence for aggregate controls."""
