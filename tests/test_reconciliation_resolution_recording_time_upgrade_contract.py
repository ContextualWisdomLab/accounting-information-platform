"""Upgrade contracts for pre-0026 resolution recording-time authority."""
...
_MIGRATION = _ROOT / "database/migrations/0026_reconciliation_control_recording_time_authority.sql"
...
class ReconciliationResolutionRecordingTimeUpgradeContractTests(unittest.TestCase):
    ...
    def test_upgrade_refuses_preexisting_resolution_commands_before_schema_change(self) -> None:
        """Authority-bearing pre-0026 commands require audited remediation."""
