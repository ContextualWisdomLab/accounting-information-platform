...
class ReconciliationLifecycleRecordingTimeUpgradePostgresTests(unittest.TestCase):
    """Prove migration 0027 never promotes unverifiable legacy transition time."""
    ...
    def test_non_bypass_upgrade_rejects_pre_0027_transition_chronology(self) -> None:
        ...
        migration_0026 = (
            migration_root / "0026_reconciliation_control_recording_time_authority.sql"
        ).read_text(encoding="utf-8")
        migration_0027 = (
            migration_root / "0027_reconciliation_lifecycle_recording_time_authority.sql"
        ).read_text(encoding="utf-8")
        ...
        try:
            ...
            with psycopg.connect(
                ...
                with self.assertRaisesRegex(
                    ...
                    migration_connection.execute(migration_0027)
