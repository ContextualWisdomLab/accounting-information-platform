...
class BankStatementDetailUltimateCreditorEvidenceRedTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.first_payload = self._with_ultimate_creditor(fixture, marker, self.first_ultimate_creditor_name)
        self.second_payload = self._with_ultimate_creditor(fixture, marker, self.second_ultimate_creditor_name)
    ...
    def test_entry_lookup_preserves_ultimate_creditor_evidence_hash(self) -> None:
        ...
        expected_hash = "sha256:" + hashlib.sha256(self.first_ultimate_creditor_name.encode("utf-8")).hexdigest()
        self._assert_digest_only_projection_delta(first_detail, baseline_detail, "ultimate_creditor_evidence_hash", expected_hash)
