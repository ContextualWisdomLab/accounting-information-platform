...
MIGRATION_PATH = ROOT / "database/migrations/0035_trial_balance_snapshot_hard_close_pair.sql"
...
def test_canonical_installer_cannot_stop_before_snapshot_pair_guard() -> None:
    """Every supported foundation install reaches migration 0035."""
