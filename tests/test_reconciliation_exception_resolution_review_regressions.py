...
_MIGRATION = _ROOT / "database/migrations/0022_reconciliation_exception_resolution_command.sql"
...
class ReconciliationExceptionResolutionReviewRegressionTests(unittest.TestCase):
    ...
    def test_upgrade_preflight_rejects_legacy_terminal_exceptions(self) -> None:
        """Migration 0022 stops before minting authority over legacy terminal rows."""
